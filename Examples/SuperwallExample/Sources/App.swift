...
@main
struct SuperwallExampleApp: App {
    @StateObject private var model = SuperwallExampleModel()
...
final class SuperwallExampleModel: ObservableObject {
    @Published var statusText: String = "Ready"
    private let purchaseDelegate: NuxieSuperwallPurchaseDelegate
