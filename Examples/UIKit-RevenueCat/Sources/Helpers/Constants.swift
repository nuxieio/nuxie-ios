...
enum Constants {
    ...
    /// Posted when mood store data changes
    static let moodStoreDidChangeNotification = Notification.Name("MoodStoreDidChange")

    /// Posted when Pro status changes
    static let proStatusDidChangeNotification = Notification.Name("ProStatusDidChange")
