...
TEST_CASES=(
  ...
  "testSystemPresentTransitionReachesDestinationScreen|screen-transition-present|System present|UIKit presents screen_2 as a native sheet modal with its own live Rive surface."
  "testSystemPresentSwipeDismissReturnsToPresentingScreen|screen-transition-present-dismissible|System present dismissal|A native sheet swipe dismisses screen_2, reports screen_dismissed, and returns the journey to screen_1."
  "testBackTransitionReturnsWithReversePushPayload|screen-transition-back-push|Back transition|screen_2 auto-runs a back action and returns to screen_1 with the reverse push payload."
  "testReduceMotionFallsBackToInstantReplacement|screen-transition-reduce-motion|Reduce motion|An authored 5s dissolve is skipped when reduce motion is forced."
...
<main>
  ...
  <section class="card summary">
    ...
    <ul>
      ...
      <li><strong>System present:</strong> UIKit presents screen_2 as a native sheet modal with its own live Rive surface.</li>
      <li><strong>System present dismissal:</strong> a native sheet swipe dismisses screen_2, reports screen_dismissed, and returns the journey to screen_1.</li>
      <li><strong>Back transition:</strong> screen_2 auto-runs a back action and returns to screen_1 with the reverse push payload.</li>
      <li><strong>Reduce motion:</strong> an authored 5s dissolve is skipped when reduce motion is forced.</li>
